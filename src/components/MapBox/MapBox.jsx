  ...
  return (
    <>
      <div className="w-full min-h-60 bg-gray-200 overflow-hidden lg:h-200 lg:aspect-none">
        {props.cityDetails.length ?
          <Map
            initialViewState={{
              latitude: props.cityDetails[1],
              longitude: props.cityDetails[0],
              zoom: 12,
            }}
          ...
          >
            <Marker longitude={props.cityDetails[0]} latitude={props.cityDetails[1]} color="white" scale='1' />
            {
